...
This data is then added to our SQL database to identify players' stats, but also their number of games and minutes in college to run statistical tests and compare college and international experience with future NBA experience.
